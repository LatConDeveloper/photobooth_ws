...
export default function CustomizeScreen({ navigation }: Props) {
  useIdleTimer('Customize', () => navigation.navigate('Attract'));

  return (
    <View style={styles.container}>
      <Text style={styles.title}>Customize Screen</Text>
      <Text style={styles.subtitle}>Templates & Filters coming in FE-E5</Text>
